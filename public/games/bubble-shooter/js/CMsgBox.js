function CMsgBox(szMsg,szButLeftText,szButCenterText,szButRightText){
    ...
    this._init = function(szMsg,szButLeftText,szButCenterText,szButRightText){
        ...
        _oMsgText = new CTLText(_oContainer, 
                    CANVAS_WIDTH/2-240, (CANVAS_HEIGHT/2)-80, 480, 140, 
        ...
        _oButLeft = new CTextButton( (CANVAS_WIDTH/2) - 200,CANVAS_HEIGHT -550,s_oSpriteLibrary.getSprite('but_play'),"LEFT",FONT_GAME,"#ffffff",30,_oContainer);
        _oButLeft.addEventListener(ON_MOUSE_UP, this._onButLeftDownRelease, this);
        
        _oButCenter = new CTextButton(CANVAS_WIDTH/2,CANVAS_HEIGHT -550,s_oSpriteLibrary.getSprite('but_play'),"CENTER",FONT_GAME,"#ffffff",30,_oContainer);
        _oButCenter.addEventListener(ON_MOUSE_UP, this._onButCenterDownRelease, this);
        
        _oButRight = new CTextButton((CANVAS_WIDTH/2) + 200,CANVAS_HEIGHT -550,s_oSpriteLibrary.getSprite('but_play'),"LEFT",FONT_GAME,"#ffffff",30,_oContainer);
