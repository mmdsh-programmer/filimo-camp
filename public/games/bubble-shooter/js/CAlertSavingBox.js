function CAlertSavingBox(szText,oParentContainer){
    ...
    this._init = function (szText) {
        ...
        _oMsg = new CTLText(_oContainer, 
                    CANVAS_WIDTH/2-200, (CANVAS_HEIGHT/2)-80, 400, 140, 
        ...
        _oButOk = new CGfxButton(CANVAS_WIDTH / 2 + 250, CANVAS_HEIGHT/2 -70, s_oSpriteLibrary.getSprite('but_exit'), _oContainer);
