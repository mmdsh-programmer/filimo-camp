function CLevelButton(iXPos,iYPos, iNum, oParentContainer){
	...
	_oImage = createSprite(oSpriteSheet, "state_active",(oSprite.width/2)/2,oSprite.height/2,oSprite.width/2,oSprite.height);                           
        ...
        _oNum = new CFormatText(0, 0, iNum, PRIMARY_FONT_COLOR, _oButton, "#ef8297", 40, "center");
...
//        }
    ...
    this.addTextOn = function(szText, szType, szFontColor = PRIMARY_FONT_COLOR, szStrokeColor = STROKE_COLOR, iFontSize = 30){        
        _bText = true;
        if(szType === "left"){
            _oText = new CFormatText(-_iWidth/4, -_iHeight/2 - 10, szText, szFontColor, _oButton, szStrokeColor, iFontSize, "left");
        } else if(szType === "center"){
            _oText = new CFormatText(0, -_iHeight/2 - 10, szText, szFontColor, _oButton, szStrokeColor, iFontSize, "center");
        } else if(szType === "bottom"){
            _oText = new CFormatText(0, -_iHeight/2 + 120, szText, szFontColor, _oButton, szStrokeColor, iFontSize, "center");
        }
        
        ///_oText.setVisible(false);
    };
    
    this.setTextPosition = function(iNewX, iNewY){
        _oText.setPosition(iNewX, iNewY);
    };
    ...
    this.setActive = function(bVal){
        ...
        if(bVal){
            ...
            _oNum.setColor(PRIMARY_FONT_COLOR, "#aaa");
        }        
    };
