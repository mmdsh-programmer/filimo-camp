function CTextButtonNoSprite(iX, iY, szText, szColor, oParentContainer, szGlow, iSize){
    ...
    this._init =function(iX, iY, szText, szColor, oParentContainer, szGlow, iSize){
        ...
        drawRect( -_oText.getMeasuredWidth()/2, -_oText.getMeasuredHeight()/2 - iOffsetY, _oText.getMeasuredWidth(), _oText.getMeasuredHeight() +2*iOffsetY );
        _oTarget = new createjs.Shape(graphics);

        _oButton = new createjs.Container();
        _oButton.x = iX;
        _oButton.y = iY;
        _oButton.addChild(_oText, _oTarget);
