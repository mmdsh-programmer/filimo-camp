function CGfxButton(iXPos,iYPos,oSprite, oParentContainer){
    ...
    this.popShowAnimation = function(oCbCompleted = null, oCbScope){
        _oButton.scaleX = _oButton.scaleY = 0;
        
        createjs.Tween.get(_oButton)
                        .to({scaleX: 1, scaleY: 1}, randomIntBetween(500, 650), createjs.Ease.bounceOut)
                        .call(function(){
