function CWarningPanel(){
    ...
    this._init = function(){
        ...
        _oMsgText = new CFormatText(CANVAS_WIDTH/2, 630, TEXT_GAMERESTART, PRIMARY_FONT_COLOR, s_oStage, STROKE_COLOR, 80, "center");
        _oMsgText.setOutline(8);
        
        _oMsgText2 = new CFormatText(CANVAS_WIDTH/2, 800, TEXT_WARNING, PRIMARY_FONT_COLOR, s_oStage, STROKE_COLOR, 60, "center", PRIMARY_FONT, 250, 800);
        
        _oMsgText3 = new CFormatText(CANVAS_WIDTH/2, 950, TEXT_SURE, "#ffe468", s_oStage, STROKE_COLOR, 50, "center");
