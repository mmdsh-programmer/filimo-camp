...
var TEXT_HELP1      = "Match 3 or more pieces\nin a row and reach the level's goal!\nHurry up!\nTime is limited!";
var TEXT_HELP3      = "The bomb will blow a bunch of pieces!";
var TEXT_HELP5      = "A new Pink jelly\nis now available\n\nGet them all!";
var TEXT_HELP8      = "The wood blocks\ndon’t allow you\nto reach your beloved\njellies...\n\nBreak them!";
var TEXT_HELP11     = "Your passion for jellies \ndeserves extra time! \n\nClick on the hourglass \nto get it!";
var TEXT_HELP13     = "You can’t have \nenough??? \n\nIt’s time to find \nall the Doggy Jelly!!!";
var TEXT_HELP15     = "Touch it when it \nturns into your \nfavorite jelly pieces \nto get them all!";
var TEXT_HELP17     = "You got a special \nunique candy! \n\nLet it fall down \nmatching all the \njelly around it!";
var TEXT_HELP19     = "Wait, wait, wait! \nYou are collecting too \nmany jellies! \nFrom this moment on, \nyou can’t touch all \nthe caged ones!!!";
...
//TIME ATTACK
var TEXT_HELP   = "Match 3 or more identical jellies to make them explode before time runs out!";
var TEXT_HELP2 = "If you match 4 or more identical jellies you'll get extra time!";
...
var TEXT_HELP_CHANGING = "Match 5 identical jellies in a row to get a jolly that will destroy all identical jellies and will give you extra time";
...
function refreshLanguage(){
    switch(s_iCurLang){
        case LANG_EN:{
                //ENGLISH
				TEXT_TIME_ATTACK = "محدودیت\nزمانی";
				TEXT_STORY_MODE  = "روش%sمرحله ای";

				//STORY MODE
				TEXT_GAMEOVER  = "باختی";
				TEXT_WIN       = "مرحله تکمیل شد";
				TEXT_TIMEBONUS = "امتیاز زمان: %s";
				TEXT_TOTAL     = "امتیاز کل: %s";
				TEXT_NEXT      = "مرحله بعدی";
				TEXT_CREDITS   = "اعتبار";
				TEXT_ISPAUSED  = "توقف";
				TEXT_STAGE     = "مرحله %s";

				TEXT_SELECT_LEVEL = "انتخاب مرحله";

				TEXT_SCORES    = "امتیازات: %s";
				TEXT_SCORE     = "امتیاز\n%s";
				TEXT_TOTALSCORE = "امتیاز کل\n%s";
				TEXT_TIME      = "زمان باقیمانده:";

				TEXT_HELP1      = "حداقل ۳ تا خونه\nتو یک ردیف رو با هم مچ کن!\nتا امتیاز مناسب بگیری!\nوقتت محدوده!";
				TEXT_HELP3      = "یه بمب کلی از خونه‌های اطرافشو منفجر میکنه!";
				TEXT_HELP5      = "یه خونه صورتی اضافه شد\n سريع بگیرش!";
				TEXT_HELP8      = "خونه های چوبی\n نمیزاره به امتیاز برسی...\n\n بشکنشون";
				TEXT_HELP11     = "با این تلاشی که میکنی \n باید زمان بیشتری بهت بدیم! \n\n رو ساعت شنی بزن تا زمان بگیری!";
				TEXT_HELP13     = "به اندازه کافی نداری??? \n\nدیگه وقتشه خونه‌های ژله‌ای \nکه سگ داره رو پیدا کنی!!!";
				TEXT_HELP15     = "وقتی خونه‌های محبوبت رو میبینی \nهمه رو سریع مچ کن تا \nامتیاز خوب بگیری!";
				TEXT_HELP17     = "یدونه آبنبات ویژه گرفتی \n\nازش استفاده کن تا بره و \nسر جای خوش بشینه!";
				TEXT_HELP19     = "صبر کن ببینم! \nتو دیگه داری خیلی خونه‌ها رو \nبا هم مچ میکنی \nیکم آروم‌تر بازی کن بابا!!!";
				TEXT_HELP22     = "حرف آخر… \n\n همه امتيازا رو بگیر زود!";

				TEXT_CONGRATULATIONS = "تبریک میگیم!";
				TEXT_END_2     = "همه خونه ها رو گرفتی!\nخیلی حرفه‌ای هستی!!!";
				TEXT_END_4     = "اگه میخوای امتیاز بهتر بگیری,\n دوباره بازی کن!";

				//TIME ATTACK
				TEXT_HELP   = "قبل اینکه زمان تموم بشه، ۳ یا چند تا خونه رو با هم مچ کن!";
				TEXT_HELP2 = "اگه ۴ تا خونه رو با هم مچ کنی زمان بیشتری بدست میاری!";
				TEXT_HELP_ITEM = "آیتم‌های جایزه";
				TEXT_HELP_BOMB = "اگه ۴ تا خونه رو با هم مچ کنی یدونه بمب بهت میدیم";
				TEXT_HELP_CLOCK = "اگه خوش شانس باشی میتونی زمان بیشتری بگیری";
				TEXT_HELP_CHANGING =  "اگه ۵ تا خونه تو یک ردیف رو با هم مچ کنی یک قدرت ویژه بهت میدیم";
				TEXT_BEST_SCORE = "بهترین امتیاز\n%s";
				TEXT_TIME_IS_UP = "وقت تموم شد!";

				TEXT_SHUFFLE   = "دیگه خونه‌‌ای برای مچ کردن نداری...";

				TEXT_GAMERESTART = "بازی محدد";
				TEXT_WARNING = "با این انتخاب\n تمام امتیازاتت پاک میشه";
				TEXT_SURE = "آیا مطمئنی?";

				TEXT_VIDEO_REWARD = "یه ویدیو تبلیغی نگاه کن تا زمان بیشتری بگیری";
        ...
        case LANG_ES:{
            ...
            TEXT_HELP1      = "¡Une 3 o más piezas\nseguidas y alcanza el objetivo de cada nivel!\n¡Date prisa!\n¡El tiempo es limitado!";
            TEXT_HELP3      = "¡La bomba hará estallar un montón de piezas!";
            TEXT_HELP5      = "Hay disponible\nuna nueva gelatina rosa\n\n¡Hazte con todas!";
            TEXT_HELP8      = "Si los bloques de madera\nno te permiten\nllegar hasta tus queridas\ngelatinas...\n\n¡Destrózalos!";
            TEXT_HELP11     = "¡Tu pasión por las gelatinas \nmerece un tiempo extra! \n\n¡Haz clic en el reloj de arena \npara conseguirlo!";
            TEXT_HELP13     = "¿¿¿No tienes \nsuficiente??? \n\n¡¡¡Es hora de encontrar \ntoda la gelatina perruna!!!";
            TEXT_HELP15     = "¡Toca cuando \nse convierta en tu \ntrozo de gelatina favorito \npara hacerte con todos!";
            TEXT_HELP17     = "¡Tienes una golosina \núnica y especial! \n\n¡Déjala caer \nuniendo así toda la \ngelatina a su alrededor!";
            TEXT_HELP19     = "¡Esper, espera, espera! \n¡Estás recogiendo demasiadas \ngelatinas! \n¡¡¡Desde este mismo momento, \nno podrás tocar las \nque están enjauladas!!!";
            TEXT_HELP22     = "Por último pero no menos importante… \n¡Gelatina de pollos! \n\n¡Hazte con todas!";

            TEXT_CONGRATULATIONS = "¡ENHORABUENA!";
            TEXT_END_2     = "¡Te has hecho con todas las gelatinas!\n¡¡¡Eres toda una leyenda!!!";
            TEXT_END_4     = "Si quieres mejorar tu puntuación,\n¡vuelve a jugar algunos niveles!";

            //TIME ATTACK
            TEXT_HELP   = "¡Une 3 o más gelatinas idénticas para hacer que exploten antes de que se acabe el tiempo!";
            TEXT_HELP2 = "¡Si logras juntar 4 o más gelatinas idénticas conseguirás tiempo extra!";
            TEXT_HELP_ITEM = "Objetos de bonificación";
            TEXT_HELP_BOMB = "Une 4 gelatinas idénticas seguidas para conseguir una bomba";
            TEXT_HELP_CLOCK = "Si tienes suerte, conseguirás algo de tiempo extra";
            TEXT_HELP_CHANGING = "Une 5 gelatinas idénticas seguidas para conseguir una bonificación que destrozará todas las gelatinas idénticas y te dará tiempo extra.";
        ...
        case LANG_FR:{
            ...
            TEXT_HELP1      = "Associez au moins 3 Jellies\npour atteindre l’objectif !\nFaites vite !\nLe temps est limité !";
            TEXT_HELP3      = "La bombe va faire exploser plusieurs Jellies !";
            TEXT_HELP5      = "Une nouvelle Jelly rose\nest disponible\n\nFaites-les toutes disparaître !";
            TEXT_HELP8      = "Le bois vous\nempêche d’atteindre\nvos Jellies\n adorées...\n\nCassez-le !";
            TEXT_HELP11     = "Votre passion pour les Jellies\nmérite une récompense !\n\nCliquez sur le sablier\npour obtenir du temps bonus !";
            TEXT_HELP13     = "Il vous en faut\ntoujours plus ?\n\nJetez-vous donc\nsur les Jellies toutous !";
            TEXT_HELP15     = "Touchez cette Jelly\nlorsqu’elle prend\nla forme de votre choix\npour toutes les récupérer !";
            TEXT_HELP17     = "Voici une friandise\nabsolument unique !\n\nFaites-la tomber tout\nen bas en éliminant\nles Jellies qui l’entourent !";
            TEXT_HELP19     = "Un petit instant !\nVous avez récupéré\nbien trop de Jellies !\nDésormais,\ncelles en cage\nsont protégées !";
            TEXT_HELP22     = "Et pour finir… \nla Jelly poussin !\n\nRécupérez-les toutes !";

            TEXT_CONGRATULATIONS = "FÉLICITATIONS !";
            TEXT_END_2     = "Vous avez récupéré toutes les Jellies !\nVous êtes une vraie légende !";
            TEXT_END_4     = "Pour améliorer votre score,\nrejouez certains niveaux !";

            //TIME ATTACK
            TEXT_HELP   = "Associez au moins 3 Jellies identiques pour les faire exploser avant la fin du temps imparti !";
            TEXT_HELP2 = "Si vous associez au moins 4 Jellies identiques, vous gagnez du temps bonus !";
            ...
            TEXT_HELP_CHANGING = "Associez 5 Jellies identiques pour obtenir une Jolly, qui détruira toutes les Jellies à son image et vous donnera du temps bonus";
            ...
            TEXT_VIDEO_REWARD = "Regardez une publicité pour obtenir du temps supplémentaire";
        ...
        case LANG_DE:{
            ...
            TEXT_HELP1      = "Ordne 3 oder mehr\nin einer Reihe an und erreiche das Ziel des Levels!\nBeeil dich!\nDie Zeit ist begrenzt!";
            TEXT_HELP3      = "Die Bombe wird einen Haufen von ihnen in die Luft jagen!";
            TEXT_HELP5      = "Ein neues Pink Jelly\nist jetzt verfügbar\n\nHol sie dir alle!";
            TEXT_HELP8      = "Die Holzblöcke\nhindern dich daran,\ndeine geliebten Jellys\nzu erreichen ...\n\nZerstöre sie!";
            TEXT_HELP11     = "Deine Leidenschaft für Jellys \nbenötigt zusätzliche Zeit! \n\nKlick auf die Sanduhr, \nnur so bekommst du sie!";
            TEXT_HELP13     = "Du bekommst \nnicht genug??? \n\nEs ist an der Zeit, \nalle Doggy Jellys zu finden!!!";
            TEXT_HELP15     = "Berühre es, \nwenn es sich in dein \nLieblings-Jelly verwandelt, \nso bekommst du sie alle!";
            TEXT_HELP17     = "Du hast ein besonderes \neinzigartiges Bonbon! \n\nLass es herunterfallen \nund ordne es mit den \nJellys daneben an!";
            TEXT_HELP19     = "Warte, warte, warte! \nDu sammelst zu \nviele Jellys! \nAb jetzt kommst \ndu nicht mehr \nan all die eingesperrten ran!!!";
            TEXT_HELP22     = "Zu guter Letzt … \nChicky-Jelly! \n\nHol sie dir alle!";

            TEXT_CONGRATULATIONS = "GLÜCKWUNSCH!";
            TEXT_END_2     = "Du hast alle Jellys gesammelt!\nDu bist eine Legende!!!";
            TEXT_END_4     = "Wenn du deine Punktzahl verbessern willst,\ndann spiele einige Levels noch einmal!";

            //TIME ATTACK
            TEXT_HELP   = "Ordne 3 oder mehr gleiche Jellys zusammen an, um sie explodieren zu lassen, bevor die Zeit abläuft!";
            TEXT_HELP2 = "Wenn du 4 oder mehr gleiche Jellys zusammen anordnest, bekommst du zusätzliche Zeit!";
            TEXT_HELP_ITEM = "Bonus-Items";
            TEXT_HELP_BOMB = "Ordne 4 gleiche Jellys in einer Reihe an, um eine Bombe zu erhalten";
            TEXT_HELP_CLOCK = "Wenn du Glück hast, bekommst du zusätzliche Zeit";
            TEXT_HELP_CHANGING = "Wenn du 5 gleiche Jellys in einer Reihe anordnest, bekommst du einen Jolly, der alle gleichen Jellys zerstört und dir zusätzliche Zeit verschafft";
        ...
        case LANG_PT:{
            ...
            TEXT_HELP1      = "Combina 3 ou mais peças\nem linha para atingir o objetivo!\nRápido!\nO tempo é limitado!";
            TEXT_HELP3      = "A bomba vai rebentar com algumas peças!";
            TEXT_HELP5      = "Uma nova gelatina Rosa\nestá disponível\n\nApanha-as todas!";
            TEXT_HELP8      = "Os blocos de madeira\nnão te deixam\nchegar às tuas preciosas\ngelatinas...\n\nAcaba com eles!";
            TEXT_HELP11     = "A tua paixão por gelatinas \nmerece mais tempo! \n\nToca na ampulheta \npara ganhar mais tempo!";
            TEXT_HELP13     = "Não tens tempo \nsuficiente??? \n\nEstá na hora de achar \ntodas as Gelatinas de Cãezinhos!!!";
            TEXT_HELP15     = "Toca na gelatina quando \nse transforma na tua \npeça de Gelatina favorita \npara as receberes todas!";
            TEXT_HELP17     = "Recebeste um \ndoce único! \n\nDeixa-o cair para \ncombinar com todas as \ngelatinas à volta!";
            TEXT_HELP19     = "Espera lá! \nEstás a recolher \ndemasiadas gelatinas! \nA partir de agora, \nnão podes tocar em todas \nas que estejam presas!!!";
            TEXT_HELP22     = "Por último... \nGelatina de Piu-piu! \n\nApanha-as todas!";

            TEXT_CONGRATULATIONS = "PARABÉNS!";
            TEXT_END_2     = "Recolheste todas as Gelatinas!\nÉs uma lenda!!!";
            TEXT_END_4     = "Se queres melhorar a tua pontuação,\njoga certos níveis novamente!";

            //TIME ATTACK
            TEXT_HELP   = "Combina 3 ou mais gelatinas iguais para as fazer explodir antes do tempo acabar!";
            TEXT_HELP2 = "Se combinares 4 ou mais gelatinas iguais, ganhas mais tempo!";
            TEXT_HELP_ITEM = "Itens Bónus";
            TEXT_HELP_BOMB = "Combina 4 gelatinas iguais em linha para ganhares uma bomba";
            TEXT_HELP_CLOCK = "Se tiveres sorte, ganhas tempo extra";
            TEXT_HELP_CHANGING = "Combina 5 gelatinas iguais em linha para ganhares uma peça que rebenta com todas as gelatinas iguais e dá tempo extra";
            ...
            TEXT_VIDEO_REWARD = "Vê um vídeo de publicidade para ganhares tempo extra";
        ...
        case LANG_IT:{
            ...
            TEXT_HELP_CHANGING = "Combina 5 gelatine identiche per ottenere un jolly che farà esplodere tutte le gelatine identiche e otterrai tempo extra per ogni gelatina catturata";
        ...
        case LANG_RU:{
            ...
            //TIME ATTACK
            TEXT_HELP   = "Объединяйте одинаковые мармеладки по 3 или более, чтобы убрать их, пока не истекло время!";
            TEXT_HELP2 = "Объединив 4 или более мармеладок, вы получите дополнительное время!";
            TEXT_HELP_ITEM = "Бонусные предметы";
            TEXT_HELP_BOMB = "Объедините 4 одинаковых мармеладки, чтобы получить бомбу";
            TEXT_HELP_CLOCK = "Если повезет, получите дополнительное время";
            TEXT_HELP_CHANGING = "Объедините 5 одинаковых мармеладок и получите мультиладку, которая уберет все одинаковые мармеладки и добавит времени";
            ...
            TEXT_VIDEO_REWARD = "Посмотрите рекламу, чтобы получить дополнительное время.";
