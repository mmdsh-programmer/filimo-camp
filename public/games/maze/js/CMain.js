function CMain(oData) {
    ...
    this._initSounds = function(){
        ...
        s_aSoundsInfo.push({path: './sounds/',filename:'moving',loop:false,volume:1, ingamename: 'moving'});
    ...
    this._loadImages = function () {
        ...
        for (var i = 0; i < 18; i++) {
            s_oSpriteLibrary.addSprite("bg_menu"+i, "./sprites/bg_menu/bg_menu_" + i + ".jpg");
        };
        ...
        s_oSpriteLibrary.addSprite("horiz_wall", "./sprites/hwall.png");
        s_oSpriteLibrary.addSprite("vert_wall", "./sprites/vwall.png");
        ...
        s_oSpriteLibrary.addSprite("press_hand","./sprites/press_hand.png");
...
var s_oCanvas;
var s_aBestScore = [0,0,0];

var s_bStorageAvailable = true;
var generated = false;
var s_aCellList = new Array();
var oWallUp = 0;
var oWallRight = 1;
var oWallDown = 2;
var oWallLeft = 3;
