function CMsgBox(szMsg,szButLeftText,szButCenterText,szButRightText){
    ...
    this._init = function(szMsg,szButLeftText,szButCenterText,szButRightText){
        ...
        _oMsgText = new CTLText(_oContainer, 
                    CANVAS_WIDTH/2 - 80, (CANVAS_HEIGHT/2)-80, 210, 130, 
        ...
        _oButLeft = new CTextButton( (CANVAS_WIDTH/2) - 100,CANVAS_HEIGHT -150,s_oSpriteLibrary.getSprite('but_generic_small'),"LEFT",FONT_GAME,"#ffffff",50,_oContainer);
        _oButLeft.addEventListener(ON_MOUSE_UP, this._onButLeftDownRelease, this);
        
        _oButCenter = new CTextButton(CANVAS_WIDTH/2,CANVAS_HEIGHT -150,s_oSpriteLibrary.getSprite('but_generic_small'),"CENTER",FONT_GAME,"#ffffff",50,_oContainer);
        _oButCenter.addEventListener(ON_MOUSE_UP, this._onButCenterDownRelease, this);
        
        _oButRight = new CTextButton((CANVAS_WIDTH/2) + 90,CANVAS_HEIGHT -150,s_oSpriteLibrary.getSprite('but_generic_small'),"LEFT",FONT_GAME,"#ffffff",50,_oContainer);
