            ...
            <div className="p-[3px] rounded-[28.5px] shadow-[0_2px_7px_0_rgba(0,0,0,0.26)] flex bg-white items-center">
              ...
              >
                <img
                  ...
                  src={require(`images/common/avatars/${FindAvatarAdd(parseInt(user?.avatar_code))}`)}
                  alt="avatar logo"
                />
              </figure>
              ...
              >
                <g id="map-01 (1) 1" clipPath="url(#clip0_526_1436)">
                  ...
                  <g id="road">
                    ...
                    <g id="level_1" onClick={() => handleLevelClick(1)} viewBox="0 0 63 63">
                ...
                <ul className="list-none flex flex-col gap-y-4">
                  ...
                  <li className="flex">
                    ...
                    <span className="inline-block font-dana-regular">
                      ...
                      <span className="text-sm text-black">{userScorsTable?.casual_score}</span>
                    </span>
                  </li>
                  ...
                  <li className="flex">
                    ...
                    <span className="inline-block font-dana-regular">
                      ...
                      <span className="text-sm text-black">{userScorsTable?.mission_score}</span>
                    </span>
                  </li>
                  ...
                  <li className="flex">
                    ...
                    <span className="inline-block font-dana-regular">
                      ...
                      <span className="text-sm text-black">{userScorsTable?.watch_time_score}</span>
                    </span>
                  </li>
                  ...
                  <li className="flex">
                    ...
                    <span className="inline-block font-dana-regular">
                      ...
                      <span className="text-sm text-black">{userScorsTable?.referral_score}</span>
                    </span>
                  </li>
            ...
            <div className="flex flex-col gap-y-2 my-4">
              ...
              >
                ...
                <span className="text-sm text-black ml-auto mt-1 font-dana-regular flex items-center">
                  ...
                  <span>{casual_levels.current[challengeLevel.current - 1]?.value}</span>
                </span>
              ...
              >
                ...
                <span className="text-sm text-black ml-auto mt-1 font-dana-regular flex items-center">
                  <span className="score-title ml-1">امتیاز</span>
                  <span>{mission_levels.current[challengeLevel.current - 1]?.value}</span>
                </span>
